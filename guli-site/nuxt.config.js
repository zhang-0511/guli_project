  ...
  */
  head: {
    ...
    link: [
      ...
      { rel: "stylesheet", href: "//at.alicdn.com/t/font_3433855_rz740hale3.css" },
      { rel: "stylesheet", href: "https://g.alicdn.com/de/prismplayer/2.9.21/skins/default/aliplayer-min.css" }
    ],
    script:[
      {src:'https://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js',charset:'utf-8', type:'text/javascript'},
      {src:'https://g.alicdn.com/de/prismplayer/2.9.21/aliplayer-min.js',charset:'utf-8', type:'text/javascript'}
    ]
  },
  /*
