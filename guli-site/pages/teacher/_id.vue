        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            <section class="t-infor-pic">
              <img :src="teacher.avatar" :alt="teacher.name" style="width: 288px; height: 288px;">
            </section>
            <h3 class="hLh30">
              ...
              <li v-for="(course,index) in courseList" :key="index">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    <img :src="course.cover" :alt="course.title" class="img-responsive" style="width: 268px; height: 150px;">
                    <div class="cc-mask">
...
export default {
  ...
  created() {
    if (this.$route.params.id){
      this.findByIdTeacher(this.$route.params.id)
    }
  }
};
</script>
